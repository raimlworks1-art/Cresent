...
local Theme = {
	...
	Accent = Color3.fromRGB(80, 200, 180),
...
function Library:Create(config)
	local Title = config.Title or "No Title"
	...
	Utility:Create("UICorner", {CornerRadius = UDim.new(0, 3), Parent = MainFrame})
...
local Avatar = Utility:Create("ImageLabel", {
    ...
    Image = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. Players.LocalPlayer.UserId .. "&width=48&height=48&format=png"
})
...
Utility:Create("TextLabel", {
    ...
    Parent = MainFrame,
    BackgroundTransparency = 1,
    Position = UDim2.new(0, 175, 0, 20), -- Changed 150 to 175 (X) and 40 to 20 (Y)
    Size = UDim2.new(1, -190, 1, -35),    -- Adjusted size to match the new position
  ...
  TabBtn.MouseButton1Click:Connect(function()
    ...
    game:GetService("TweenService"):Create(TabBtn, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
        BackgroundColor3 = selected and Theme.Accent or Theme.Sidebar
    }):Play()
end)
